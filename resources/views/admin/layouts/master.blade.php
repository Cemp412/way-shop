...
<!-- jQuery -->
      ...
      <!-- End Theme label Script
         ...
         <script>
            ...
            $(".ProductStatus").change(function(){
             ...
             //update featured_products status
    ...
    var fieldHTML = '<div style="display:flex;"><input type="text" name="sku[]" id="sku" value="" placeholder="SKU" class="form-control" style="width: 120px; margin-right: 5px;" /><input type="text" name="size[]" id="size" value="" placeholder="SIZE" class="form-control" style="width: 120px; margin-right: 5px;" /><input type="text" name="price[]" id="price" value="" placeholder="PRICE" class="form-control" style="width: 120px; margin-right: 5px;" /><<input type="text" name="stock[]" id="stock" value="" placeholder="STOCK" class="form-control" style="width: 120px; margin-right: 5px;" /><a href="javascript:void(0);" class="remove_button">Remove</a></div>'; //New input field html 
