                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonlist"> 
                                 <a class="btn btn-add" href="/admin/add-category"> <i class="fa fa-plus"></i> Add Category
                                 </a>  
                              </div>
                              ...
                              <table id="#table_id" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{$category->url}}</td>
                                       <td>
                                          <input type="checkbox" class="ProductStatus btn btn-success" rel="{{$category->id}}" data-toggle="toggle" data-on="Enabled" data-off="Disabled" data-onstyle="success" data-offstyle="danger"
